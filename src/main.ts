import { MarkdownView, Notice, Plugin, TAbstractFile, TFile, getAllTags, normalizePath } from 'obsidian';
import { AutoNoteMoverSettingTab, AutoNoteMoverSettings, DEFAULT_SETTINGS } from 'settings/settings';
import { fileMove, getTriggerIndicator, isFmDisable } from 'utilities/utilities';
